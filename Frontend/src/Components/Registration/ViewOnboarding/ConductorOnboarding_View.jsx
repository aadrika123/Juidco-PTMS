...
import ConductorOnboarding_Table from "../../Tables/ConductorOnboarding_Table";

export default function ConductorOnboarding_View() {
    ...
    <div className="flex flex-1 ">
      <div className="flex flex-col flex-1 bg-[#F9FAFC]">
        <div className="flex h-10 justify-between items-center">
          ...
          <div className="flex text-xl font-normal  mr-4">Conductor Onboarding</div>
        </div>

        <div className="flex  m-4 p-2 bg-white  justify-start rounded-lg shadow-lg">
          <ConductorOnboarding_Table />
        </div>
      </div>
    </div>
  );
